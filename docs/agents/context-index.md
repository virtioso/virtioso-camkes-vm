...
- Updated: 2026-05-12 (Guitu, emukit, HCM safety controller, system-app, signals, build-test-tools deep-dives added; exmebus library + CANopenSDO OD added to normet-codebase-survey.md — all backlog items cleared)
